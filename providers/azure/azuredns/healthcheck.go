...
// CreateHealthCheck creates a new Azure DNS health check.
//
...
func (m *Mock) CreateHealthCheck(_ context.Context, cfg driver.HealthCheckConfig) (*driver.HealthCheckInfo, error) {
	...
	id := idgen.AzureID(m.opts.AccountID, "cloud-mock", "Microsoft.Network", "trafficManagerProfiles/healthChecks",
		idgen.GenerateID("hc-"))
...
// DeleteHealthCheck deletes an Azure DNS health check by ID.
...
// GetHealthCheck retrieves an Azure DNS health check by ID.
...
// UpdateHealthCheck updates an existing Azure DNS health check.
//
//nolint:gocritic // hugeParam: interface method signature cannot be changed.
...
// SetHealthCheckStatus sets the status of an Azure DNS health check.
