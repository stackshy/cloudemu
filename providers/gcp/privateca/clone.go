...
// a value handed back to a caller (which the wire layer would otherwise be free to
// mutate). The Fields raw map's bytes are copied.
func cloneResource(r *pcadriver.Resource) pcadriver.Resource {
	out := *r
