...
type Networking interface {
	...
	CreateNetworkInterface(
		ctx context.Context, subnetID, description string, groups []string, tags map[string]string,
...
func (m *Mock) place(ctx context.Context, net Networking, subnetID, displayName, hostname string,
	...
	nic, err := net.CreateNetworkInterface(ctx, subnetID, displayName, nsgIDs, tags)
	if err != nil {
		return out, err
	}
