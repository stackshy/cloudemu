...
import (
	...
	metastoreprovider "github.com/stackshy/cloudemu/v2/providers/gcp/metastore"
	"github.com/stackshy/cloudemu/v2/server/gcp/lro"
)

func newHandler() *Handler {
	mock := metastoreprovider.New(config.NewOptions(config.WithProjectID("p")))
...
func TestMatchesNarrowing(t *testing.T) {
	...
	cases := []struct {
		...
		{"services collection", "/v1/projects/p/locations/us-central1/services", true},
		{"service item", "/v1/projects/p/locations/us-central1/services/s", true},
		...
		{"regions space (dataproc)", "/v1/projects/p/regions/us-central1/services", false},
		{"bare location", "/v1/projects/p/locations/us-central1", false},
		{"non-v1 path", "/compute/v1/projects/p/locations/us-central1/services", false},
	}
