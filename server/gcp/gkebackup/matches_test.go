...
import (
	...
	gkebackupprovider "github.com/stackshy/cloudemu/v2/providers/gcp/gkebackup"
	"github.com/stackshy/cloudemu/v2/server/gcp/lro"
)

func newHandler() *Handler {
	mock := gkebackupprovider.New(config.NewOptions(config.WithProjectID("p")))
...
func TestMatchesNarrowing(t *testing.T) {
	...
	cases := []struct {
		...
		{"backupPlans collection", "/v1/projects/p/locations/us-central1/backupPlans", true},
		{"backupPlan item", "/v1/projects/p/locations/us-central1/backupPlans/b", true},
		{"restorePlans collection", "/v1/projects/p/locations/us-central1/restorePlans", true},
		{"restorePlan item", "/v1/projects/p/locations/us-central1/restorePlans/r", true},
		...
		{"regions space (dataproc)", "/v1/projects/p/regions/us-central1/backupPlans", false},
		{"bare location", "/v1/projects/p/locations/us-central1", false},
		{"non-v1 path", "/dns/v1/projects/p/locations/us-central1/backupPlans", false},
	}
