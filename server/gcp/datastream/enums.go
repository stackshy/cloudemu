...
// stateNames maps the Stream.State proto integer value to its canonical name;
// index 0 (STATE_UNSPECIFIED) maps to no name and is never emitted.
//
//nolint:gochecknoglobals // immutable ordinal enum table
var stateNames = []string{
	"", "NOT_STARTED", "RUNNING", "PAUSED", "MAINTENANCE",
	"FAILED", "FAILED_PERMANENTLY", "STARTING", "DRAINING",
}
...
// identify a Datastream enum are rewritten, and only when their value is a JSON
