...
// toResourceJSON renders a driver resource as securesourcemanager/v1 wire JSON,
// merging the verbatim body fields (including the seeded computed blocks) with
// the computed name/createTime/updateTime output fields.
func (c *collection) toResourceJSON(r *ssmdriver.Resource) (json.RawMessage, error) {
