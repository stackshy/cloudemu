...
import (
	...
	cloudidsprovider "github.com/stackshy/cloudemu/v2/providers/gcp/cloudids"
	"github.com/stackshy/cloudemu/v2/server/gcp/lro"
)

func newHandler() *Handler {
	mock := cloudidsprovider.New(config.NewOptions(config.WithProjectID("p")))
...
func TestMatchesNarrowing(t *testing.T) {
	...
	cases := []struct {
		...
		{"endpoints collection", "/v1/projects/p/locations/us-central1/endpoints", true},
		{"endpoint item", "/v1/projects/p/locations/us-central1/endpoints/e", true},
		{"connectors space (vpcaccess)", "/v1/projects/p/locations/us-central1/connectors/c", false},
		...
		{"regions space (dataproc)", "/v1/projects/p/regions/us-central1/endpoints", false},
		{"bare location", "/v1/projects/p/locations/us-central1", false},
		{"non-v1 path", "/compute/v1/projects/p/locations/us-central1/endpoints", false},
	}
