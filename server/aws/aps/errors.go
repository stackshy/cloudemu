...
// statusForException returns the HTTP status for an APS exception name.
...
// exceptionForCode maps a canonical cloudemu code to an APS exception name for
...
// writeErr maps a driver error to the precise APS exception. Tagged
...
// yields an empty map (e.g. a create with no fields).
