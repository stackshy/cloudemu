...
// statusForException returns the HTTP status for a Location exception name.
...
// exceptionForCode maps a canonical cloudemu code to a Location exception name
...
// writeErr maps a driver error to the precise Location exception. Tagged
