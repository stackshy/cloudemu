...
// AWS HealthLake exception names, as they appear in the __type member of a JSON
// 1.0 error body. These are the exact names the
// aws-sdk-go-v2/service/healthlake client (and terraform-provider-aws) match on.
const (
...
// APIError tags a canonical cloudemu error with the HealthLake exception name it
