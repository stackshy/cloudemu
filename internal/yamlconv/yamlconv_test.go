...
func TestDecodeScalars(t *testing.T) {
	...
	cases := []struct {
		...
		{"true", "v: true", true},
		{"False", "v: False", false},
		{"yes is true", "v: yes", true},
		{"Off is false", "v: Off", false},
		{"ON is true", "v: ON", true},
		{"quoted yes stays string", "v: 'yes'", "yes"},
		{"explicit str yes stays string", "v: !!str no", "no"},
		{"y stays string", "v: y", "y"},
		{"account ID keeps leading zero", "v: 012345678901", "012345678901"},
		{"08 stays string", "v: 08", "08"},
		{"negative leading zero stays string", "v: -09", "-09"},
		{"octal", "v: 0755", json.Number("493")},
		{"zero", "v: 0", json.Number("0")},
		{"leading zero float", "v: 0.5", json.Number("0.5")},
		{"null", "v: null", nil},
		{"tilde", "v: ~", nil},
		{"empty", "v:", nil},
